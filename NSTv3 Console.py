...
print('style matrix string :')
style_matrix_str = input()
print('style distance string :')
style_distance_str = input()
...
input_dict = {
    ...
    'style_matrix_str': style_matrix_str,          # gram_matrix, channel_wise_mean_matrix
    'style_distance_str': style_distance_str,            # mean_squared_error, minskowki_distance, js_divergence
